...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { path: "/biology", label: "Biology", icon: Dna, color: "biology" },
    { path: "/chemistry", label: "Chemistry", icon: Atom, color: "chemistry" },
    { path: "/physics", label: "Physics", icon: Orbit, color: "physics" },
    { path: "/quiz", label: "Quiz Hub", icon: Sparkles, color: "primary" },
  ];
